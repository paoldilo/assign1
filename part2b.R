...
####parte 1
mainCorpus<-Corpus(DirSource("./en_US/",pattern = "en_US.news.txt.aa"))
...
####parte 2
mainCorpus<-Corpus(DirSource("./en_US/",pattern = "en_US.news.txt.ab"))
mainCorpus<-tm_map(mainCorpus,removePunctuation)
mainCorpus<-tm_map(mainCorpus, content_transformer(tolower))
mainCorpus<-tm_map(mainCorpus,removeNumbers)
mainCorpus <- tm_map(mainCorpus, rmSpecialChars, "/|@|\\|#|€|£|$")
...
####parte 3
mainCorpus<-Corpus(DirSource("./en_US/",pattern = "en_US.news.txt.ac"))
mainCorpus<-tm_map(mainCorpus,removePunctuation)
mainCorpus<-tm_map(mainCorpus, content_transformer(tolower))
mainCorpus<-tm_map(mainCorpus,removeNumbers)
mainCorpus <- tm_map(mainCorpus, rmSpecialChars, "/|@|\\|#|€|£|$")
...
####parte 4
mainCorpus<-Corpus(DirSource("./en_US/",pattern = "en_US.news.txt.ad"))
mainCorpus<-tm_map(mainCorpus,removePunctuation)
mainCorpus<-tm_map(mainCorpus, content_transformer(tolower))
mainCorpus<-tm_map(mainCorpus,removeNumbers)
mainCorpus <- tm_map(mainCorpus, rmSpecialChars, "/|@|\\|#|€|£|$")
...
write.table(dictMatrix,file="dictionary_2w_news_part1.txt",quote=F,sep=";")
rm(dictMatrix)
gc()